    ...
    <div class="header-category mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <h1 class="fw-extrabold text-dark display-6 mb-2">Daftar Tempat Nongkrong</h1>
                <p class="text-muted mb-0">Temukan berbagai pilihan coffee shop, café aesthetic, tempat bersantai, resto keluarga, dan tempat nongkrong terfavorit.</p>
            </div>
