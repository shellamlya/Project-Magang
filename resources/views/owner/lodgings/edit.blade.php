...
@section('title', 'Edit Penginapan - Owner GREX Shella')
@section('page-title', 'Edit Penginapan Saya')
...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-body p-4 p-md-5">
        <form action="{{ route('owner.lodgings.update', $lodging->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary rounded-pill px-4 fw-bold">Update Penginapan</button>
            </div>
        </form>
    </div>
</div>
